...
import TopBarComponent from "../../../../../react-components/src/atoms/TopBar";
...
const TopBar = ({
  ...
  return (
    <div className="topbar" style={{ paddingTop: "10px", paddingBottom: "10px" }}>
      ...
      <img className="city" src="https://upload.wikimedia.org/wikipedia/commons/5/55/Emblem_of_India.svg" style={{ minWidth: "54px", height: "59px" }} />
      <span style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
        {loggedin &&
          ...
          // ))
          <strong style={{ width: "500px", marginLeft: "10px" }}>
