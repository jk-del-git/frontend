...
{`@media (min-width: 780px) {
  .banner .bannerCard, .loginFormStyleEmployee .employeeCard {
    ...
    <Background>
    <Card className="bannerCard removeBottomMargin customLanguageCard" style={{width: "510px"}}>
      <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          >
            ...
            <div style={{ marginLeft: "12px", textAlign: "left" }}>
              <h3 style={{ color: "#0C3A60", fontSize: "20px", margin: "0" }}>
                <strong>Housing and Urban Development Deparment</strong>
              </h3>
      ...
      <div style={{ width: '100%', position: 'fixed', bottom: 0,backgroundColor:"white",textAlign:"center" }}>
        <div style={{ display: 'flex', justifyContent: 'center', color:"black" }}>
          ...
          <a style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"12px", fontWeight: "400"}} href="#" target='_blank'>Housing and Urban Development Deparment</a>

          <span  className="upyog-copyright-footer" style={{ margin: "0 10px",fontSize:"12px" }} >|</span>
          <span  className="upyog-copyright-footer" style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"12px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Copyright © 2026 Government of Jammu & Kashmir</span>
          
          {/* <a style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} href="#" target='_blank'>UPYOG License</a> */}

        </div>
        <div className="upyog-copyright-footer-web">
          <span className="" style={{ cursor: "pointer", fontSize:  window.Digit.Utils.browser.isMobile()?"14px":"16px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Copyright © 2026 Government of Jammu & Kashmir</span>
          </div>
      </div>
    </Background>
    </React.Fragment>
