...
const EmployeeSideBar = () => {
  ...
  return (
    ...
    <div className="sidebar" ref={sidebarRef} onMouseOver={expandNav} onMouseLeave={collapseNav} style={{display:window.location.href.includes("main-dashboard-landing")?"none":"", background: "#0C2A60"}}>
      {renderSearch()}
      {splitKeyValue()}
    </div>
    </React.Fragment>
