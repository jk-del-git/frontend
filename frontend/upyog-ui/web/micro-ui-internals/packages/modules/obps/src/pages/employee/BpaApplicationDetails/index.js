...
const BpaApplicationDetail = () => {
  ...
  } else if(data && (data?.applicationData?.businessService === "BPA"||data?.applicationData?.businessService==="BPA-PAP" ||data?.applicationData?.businessService==="BPAC1") && data?.collectionBillDetails?.length > 0) {
